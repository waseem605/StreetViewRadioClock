package com.liveearth.streetview.navigation.map.worldradio.StreetViewGlobe;
...
public class StreetViewGeneralGlobeRadioActivity extends StreetViewBasicGlobeRadioActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setAboutBoxTitle("About the " + this.getResources().getText(R.string.app_name));
